...
export class Retur extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    sager = CasesAPI.sortByStatus(nextProps.getSager(), "Udgået");
      ...
      <Table fixedHeader >
        <TableHeader displaySelectAll={false} adjustForCheckbox={false} style={tableStyles.tableHeader}>
          <TableRow >
            ...
            <TableRowColumn style={{textAlign:'right'}}>Mere</TableRowColumn>
          </TableRow>
        </TableHeader>
